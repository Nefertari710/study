...
1. maven 介绍
	...
	3. 下载 
		...
		- maven-3.8.5-bin.zip   8.35M大小![](实习/图片资源/实习笔记图片资源/第八天/P2.png)
	4. 安装
		- 直接解压到想安装的位置就可以
	...
	6. 在命令行中,执行 mvn -version 
		- 配置完成后效果![](实习/图片资源/实习笔记图片资源/第八天/P3.png)
		- 再执行命令 -> mvn help:system
			- 作用:输出系统相关信息![](实习/图片资源/实习笔记图片资源/第八天/P4.png)
	7.  (==重要的配置==)配置本地仓库的位置	
		...
		```
		- 位置自己定-需要提前自己创建好maven-repository文件夹![](实习/图片资源/实习笔记图片资源/第八天/P5.png)
	8. 配置镜象仓库的位置
...
4. 在eclipse中如何配置maven
    ...
    2. window-> preference --Maven --> User Settings 
		...
		2. 在建maven项目的时候,经常会出现由于组件没有下载下来而出错的情况	
			...
			- 更新步骤1![](实习/图片资源/实习笔记图片资源/第八天/P7.png)
			- 更新步骤2![](实习/图片资源/实习笔记图片资源/第八天/P8.png)
